 ...
 * SingleTreeNode.
 */
public class JamMCTSPlayer extends AbstractPlayer {

    Random rnd;
    MCTSParams params;

    public JamMCTSPlayer() {
        this(System.currentTimeMillis());
    }

    public JamMCTSPlayer(long seed) {
    ...
    public JamMCTSPlayer(MCTSParams params) {
        this.params = params;
    ...
    public AbstractAction getAction(AbstractGameState gameState, List<AbstractAction> allActions) {
        ...
        JamTreeNode root = new JamTreeNode(this, null, gameState, rnd);
