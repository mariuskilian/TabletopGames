 ...
 * SingleTreeNode.
 */
public class GroupJ_MCTSPlayer extends AbstractPlayer {

    Random rnd;
    MCTSParams params;

    public GroupJ_MCTSPlayer() {
        this(System.currentTimeMillis());
    }

    public GroupJ_MCTSPlayer(long seed) {
        this.params = new MCTSParams(seed);
        rnd = new Random(seed);
        setName("Group J MCTS");
    ...
    public GroupJ_MCTSPlayer(MCTSParams params) {
        this.params = params;
    ...
    public AbstractAction getAction(AbstractGameState gameState, List<AbstractAction> allActions) {
        ...
        GroupJ_TreeNode root = new GroupJ_TreeNode(this, null, gameState, rnd);
