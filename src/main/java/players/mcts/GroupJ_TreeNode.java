...
class GroupJ_TreeNode {
    // Root node of tree
    GroupJ_TreeNode root;
    // Parent of this node
    GroupJ_TreeNode parent;
    // Children of this node
    Map<AbstractAction, GroupJ_TreeNode> children = new HashMap<>();
    // Depth of this node
    final int depth;
    ...
    private GroupJ_MCTSPlayer player;
    private Random rnd;
    ...
    protected GroupJ_TreeNode(GroupJ_MCTSPlayer player, GroupJ_TreeNode parent, AbstractGameState state, Random rnd) {
        this.player = player;
        this.fmCallsCount = 0;
        this.parent = parent;
    ...
    void mctsSearch() {
        ...
        while (!stop) {
            ...
            GroupJ_TreeNode selected = treePolicy();
     ...
     */
    private GroupJ_TreeNode treePolicy() {

        GroupJ_TreeNode cur = this;
     ...
     */
    private GroupJ_TreeNode expand() {
        ...
        GroupJ_TreeNode tn = new GroupJ_TreeNode(player, this, nextState, rnd);
    ...
    private AbstractAction ucb() {
        ...
        for (AbstractAction action : children.keySet()) {
            GroupJ_TreeNode child = children.get(action);
            if (child == null)
    ...
    AbstractAction bestAction() {
        ...
        for (AbstractAction action : children.keySet()) {
            if (children.get(action) != null) {
                GroupJ_TreeNode node = children.get(action);
