 ...
 * SingleTreeNode.
 */
public class BasicPruningMCTSPlayer extends AbstractPlayer {

    Random rnd;
    MCTSParams params;

    public BasicPruningMCTSPlayer() {
        this(System.currentTimeMillis());
    }

    public BasicPruningMCTSPlayer(long seed) {
        this.params = new MCTSParams(seed);
        rnd = new Random(seed);
        setName("Basic Pruning MCTS");
    ...
    public BasicPruningMCTSPlayer(MCTSParams params) {
        this.params = params;
    ...
    public AbstractAction getAction(AbstractGameState gameState, List<AbstractAction> allActions) {
        ...
        BasicPruningTreeNode root = new BasicPruningTreeNode(this, null, gameState, rnd);
    ...
    public String toString() {
        return "BasicPruningMCTS";
    }

    @Override
    public BasicPruningMCTSPlayer copy() {
        return this;
    }
}